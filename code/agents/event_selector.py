...
# ### Input:
#
# - Test Semantic (Example):
#
#     ```
#     1. ACTION (TextView, "", (), click, "Family"): Select the "Family" filter from the dropdown.
#     2. ACTION (ImageButton, "", (), click, NULL): Access the overflow menu in the action bar for additional settings.
#     3. ACTION (TextView, android.R.id.title, (), click, "Settings"): Activate the "Settings" menu item.
#     4. ACTION (TextView, "", (), click, "Sort order"): Change the sorting method.
#     5. ACTION (TextView, "", (), click, "most expensive first"): Sort items starting with the most expensive.
#     6. RETURN: Go back after applying the new sort order.
#     7. ASSERT (RecyclerView, R.id.list_items, (), "ViewTextOrderAssertion"): Ensure items are sorted correctly, looking for "Meat", "Egg", and "Noodles".
#     ```
#
# - Page Intention(Example):
#
#     ```
#     ACTION (android.widget.ImageButton, NULL, (0, 24), click, NULL): Click to navigate up.
#     ACTION (android.widget.TextView, NULL, (72, 38), display, Family): Displays the current category name "Family".
#     ACTION (android.widget.TextView, "privacyfriendlyshoppinglist.secuso.org.privacyfriendlyshoppinglist:id/imageview_search", (224, 28), click, NULL): Click to search for items in the list.
#     ACTION (android.widget.ImageView, NULL, (280,28), click, NULL): Click to open more options.
#     ACTION (android.widget.ImageButton, "privacyfriendlyshoppinglist.secuso.org.privacyfriendlyshoppinglist:id/expand_button_list",(8,88), click, NULL): Click to expand or collapse the list of "Family" items.
#     ACTION (android.widget.CheckBox, "privacyfriendlyshoppinglist.secuso.org.privacyfriendlyshoppinglist:id/checkbox_is_selected",(58,88), click, NULL): Click to select or deselect "Egg" from the list.
#     ACTION (android.widget.TextView, "privacyfriendlyshoppinglist.secuso.org.privacyfriendlyshoppinglist:id/textview_product_name",(98,88), display, Egg): Displays item "Egg" in the list.
#     ACTION (android.widget.TextView, "privacyfriendlyshoppinglist.secuso.org.privacyfriendlyshoppinglist:id/textview_prod_quantity",(289,88), display, 8): Displays the quantity "8" of item "Egg".
#     ACTION (android.widget.ImageButton, "privacyfriendlyshoppinglist.secuso.org.privacyfriendlyshoppinglist:id/fab_new_product",(248,504), click, NULL): Click to add a new product to the list.
#     ACTION (android.widget.TextView, NULL, (0,576), display, Total:): Displays the total amount label.
#     ACTION (android.widget.TextView, "privacyfriendlyshoppinglist.secuso.org.privacyfriendlyshoppinglist:id/textview_total_checked",(69,576), display, 0.00): Displays the total cost of selected items.
#     ACTION (android.widget.TextView, NULL ,(132,576), display, /): Displays the divider "/" between total cost of selected items and total cost of all items.
#     ACTION (android.widget.TextView, "privacyfriendlyshoppinglist.secuso.org.privacyfriendlyshoppinglist:id/textview_total_amount",(137,576), display, 89.00): Displays the total cost for all items in the list.
#     ACTION (android.widget.TextView, "privacyfriendlyshoppinglist.secuso.org.privacyfriendlyshoppinglist:id/textview_currency",(196,598), display, $): Displays the currency symbol "$" for the total amount.
#     ```
#
#
#
# ### Output (Wrapping them all together with a pair of '~~~' like(Please make sure to comply with this format, don't miss ~~~), Your response must not have Exec_Success or Exec_Fail):
#
# ~~~
# ACTION (android.widget.ImageView, NULL, (280,28), click, NULL): Click on the overflow menu in the action bar (the 'More options' button) to open additional settings.
# ~~~
# """